...
import { ArrowLeft, Clock, User, Calendar, FileText, X, Check, SkipForward, Pause, Play, Expand, Minimize, StickyNote } from 'lucide-react';
  ...
  return <div className="max-w-7xl mx-auto p-4 sm:p-6 md:p-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="sm" onClick={() => setShowNotes(!showNotes)} className={`flex items-center gap-2 ${showNotes ? 'bg-accent text-accent-foreground' : ''}`}>
      ...
      <div className={`grid gap-6 ${isExpanded ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-3'}`}>
        ...
        {!isExpanded && <div className="lg:col-span-1">
            <Card>
