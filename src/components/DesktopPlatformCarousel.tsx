...
export const DesktopPlatformCarousel = () => {
  ...
  return (
    <div className="relative">
      ...
      <div 
        className={`relative h-[600px] w-full overflow-hidden rounded-2xl bg-card border border-border transition-all duration-1000 ${isLoaded ? 'opacity-100 transform-none' : 'opacity-0 translate-y-8'}`}
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/95 via-background/50 to-transparent p-6 sm:p-8">
          <div className="max-w-2xl">
            ...
            <div className="mt-4 w-24 h-1 bg-gradient-to-r from-primary to-accent-legal rounded-full animate-fade-in-up" style={{ animationDelay: '0.4s' }} />
          </div>
        </div>
