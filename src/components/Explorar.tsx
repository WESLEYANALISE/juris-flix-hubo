...
const functions: FunctionDetail[] = [
  {
    ...
    useCases: [
      'Consulta rápida durante estudos para concursos',
      'Pesquisa de artigos específicos durante redação de peças',
      'Verificação de alterações recentes na legislação',
      'Comparação entre diferentes códigos',
      'Estudos comparativos de legislação'
    ],
    benefits: [
      'Acesso offline a toda legislação',
      'Busca avançada por palavras-chave',
      'Histórico de alterações legislativas',
      'Marcadores e anotações personalizadas',
      'Interface otimizada para estudo'
    ],
    howToUse: [
      'Acesse através do menu principal',
      'Use a busca para encontrar leis específicas',
      'Navegue por categoria de direito',
      'Marque artigos importantes',
      'Faça anotações nos textos'
    ],
    examples: [
      'Consultar Art. 121 do Código Penal sobre homicídio',
      'Pesquisar "usucapião" no Código Civil',
      'Verificar prazos prescricionais',
      'Estudar princípios constitucionais'
    ],
    category: 'core',
  ...
  },
  {
    ...
    useCases: [
      'Memorização de conceitos para provas de OAB',
      'Revisão antes de concursos públicos',
      'Fixação de jurisprudências importantes',
      'Estudo de definições doutrinárias',
      'Preparação para arguições orais'
    ],
    benefits: [
      'Algoritmo científico de repetição',
    ...
    howToUse: [
      'Escolha a área de direito desejada',
      'Inicie uma sessão de estudos',
      'Responda honestamente sobre seu conhecimento',
      'Revise regularmente conforme sugerido',
      'Acompanhe seu progresso nas estatísticas'
    ],
    examples: [
      'Memorizar elementos do crime',
      'Fixar prazos processuais',
      'Decorar princípios administrativos',
  ...
  },
  {
    ...
    useCases: [
      'Pesquisa doutrinária para trabalhos acadêmicos',
      'Consulta de jurisprudências relevantes',
      'Leitura de manuais especializados',
      'Estudo aprofundado de temas específicos',
      'Preparação para bancas de concurso'
    ],
    benefits: [
      'Acervo constantemente atualizado',
      'Busca por autor, tema ou tribunal',
      'Download para leitura offline',
      'Sistema de favoritos',
      'Compartilhamento de trechos'
    ],
    howToUse: [
      'Navegue pelas categorias temáticas',
      'Use filtros por tipo de obra',
      'Pesquise por palavras-chave',
      'Baixe obras para leitura offline',
      'Organize sua biblioteca pessoal'
    ],
    examples: [
      'Buscar doutrina sobre direito sucessório',
      'Consultar julgados do STF sobre LGPD',
      'Baixar manual de direito penal',
      'Pesquisar artigos sobre compliance'
    ],
    category: 'core',
  ...
  },
  {
    ...
    useCases: [
      ...
      'Revisão enquanto pratica exercícios',
      'Aprendizado para pessoas com dificuldades visuais',
      'Estudos noturnos sem prejudicar o sono',
      'Multitasking durante atividades domésticas'
    ],
    benefits: [
    ...
    howToUse: [
      ...
      'Escolha o professor ou tema',
      'Baixe para ouvir offline',
      'Ajuste velocidade conforme necessário',
      'Faça anotações durante a audição'
    ],
    examples: [
      'Ouvir sobre direito tributário no trânsito',
      'Revisar processo civil durante caminhada',
      'Estudar constitucional antes de dormir',
      'Escutar sobre direito do trabalho na academia'
    ],
    category: 'study',
    difficulty: 'Iniciante',
    featured: false
  },
  {
    ...
    useCases: [
      'Preparação estruturada para concursos',
      'Estudo inicial de novas matérias',
      'Revisão visual de conceitos complexos',
      'Acompanhamento de resolução de questões',
      'Cursos preparatórios completos'
    ],
    benefits: [
    ...
    howToUse: [
      ...
      'Assista às aulas em sequência',
      'Faça anotações durante as aulas',
      'Pratique com exercícios propostos',
      'Revise pontos de dúvida'
    ],
    examples: [
      'Curso completo de Direito Administrativo',
      'Aulas de Direito Penal para OAB',
      'Módulo de Constitucional para Magistratura',
  ...
  },
  {
    ...
    useCases: [
      'Download de materiais para estudo offline',
      'Impressão de resumos para revisão',
      'Construção de biblioteca pessoal',
      'Backup de materiais importantes',
      'Compartilhamento com grupos de estudo'
    ],
    benefits: [
      'Downloads ilimitados',
      'Materiais em alta qualidade',
      'Organização por categoria',
      'Buscador avançado',
      'Novos materiais semanalmente'
    ],
    howToUse: [
      'Navegue pelas categorias',
      'Use filtros para refinar busca',
      'Visualize antes de baixar',
      'Organize em pastas locais',
      'Compartilhe com responsabilidade'
    ],
    examples: [
      'Baixar apostila de Direito Civil',
      'Download de livro sobre processo penal',
      'Obter mapas mentais de constitucional',
      'Baixar coletânea de súmulas'
    ],
    category: 'tools',
    difficulty: 'Iniciante',
    featured: false
  },
  {
    ...
    useCases: [
      ...
      'Ficar informado sobre jurisprudências',
      'Monitorar tendências do mercado',
      'Preparar-se para provas atualizadas',
      'Manter-se relevante profissionalmente'
    ],
    benefits: [
    ...
    howToUse: [
      'Acesse a seção de notícias',
      'Configure alertas por área',
      'Leia análises especializadas',
      'Compartilhe notícias relevantes',
      'Salve artigos para leitura posterior'
    ],
    examples: [
      'Nova súmula do STJ sobre direito do consumidor',
      'Alteração no Código de Processo Civil',
      'Decisão importante do STF sobre direitos fundamentais',
      'Nova lei trabalhista aprovada'
    ],
    category: 'tools',
    difficulty: 'Iniciante',
    featured: false
  },
  {
    ...
    useCases: [
      'Organizar resumos de estudo',
      'Anotar insights durante aulas',
      'Criar fichamentos de livros',
      'Registrar dúvidas para revisão',
      'Compartilhar anotações com grupos'
    ],
    benefits: [
    ...
    howToUse: [
      'Crie categorias de estudo',
      'Adicione tags às anotações',
      'Use busca para encontrar conteúdo',
      'Exporte para backup',
      'Importe anotações existentes'
    ],
    examples: [
      'Resumo sobre teoria geral do crime',
      'Anotações da aula de processo civil',
      'Fichamento de livro sobre direitos humanos',
      'Dúvidas sobre direito tributário'
    ],
    category: 'tools',
    difficulty: 'Iniciante',
    featured: true
...
const categories = [
  ...
  { id: 'core', name: 'Principais', icon: Star },
  { id: 'study', name: 'Estudo', icon: BookOpen },
  { id: 'community', name: 'Comunidade', icon: Users },
  { id: 'tools', name: 'Ferramentas', icon: Lightbulb }
];
        ...
        <Card>
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <Badge variant="outline" className="capitalize">
                    {selectedFunction.category === 'core' ? 'Principal' : 
                     selectedFunction.category === 'study' ? 'Estudo' :
                     selectedFunction.category === 'community' ? 'Comunidade' : 'Ferramenta'}
                  </Badge>
                </div>
              </div>
            </div>
          ...
          <CardContent className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {selectedFunction.benefits.map((benefit, index) => (
                  <li key={index} className="flex items-start gap-2">
            ...
            <div>
              ...
              <ol className="space-y-2">
                {selectedFunction.howToUse.map((step, index) => (
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 md:p-8">
      ...
      <div>
        <h2 className="text-2xl font-bold mb-6 text-center">
          {selectedCategory === 'all' ? '🛠️ Todas as Funcionalidades' : 
