...
import { 
  Compass, BookOpen, Video, FileText, Scale, Download, 
  Lightbulb, Target, PlayCircle, ArrowRight, CheckCircle, 
  Star, Brain, Library, Headphones, Bot, X, Users, Clock,
  TrendingUp, Award, Zap, Search, BookMarked, MessageSquare
} from 'lucide-react';
...
const funcionalidades: Funcionalidade[] = [
  {
    ...
    exemplos: [
      'Estudante de Direito consulta art. 186 do CC para entender responsabilidade civil',
      'Concurseiro busca "competência tributária" para revisar matéria da Receita Federal',
      'Advogado verifica Lei 13.709/18 (LGPD) durante consultoria empresarial'
    ],
    casosUso: [
      'Estudante preparando para 2ª fase da OAB precisa citar artigos específicos',
      'Concurseiro revisando legislação para prova de Procurador da República',
      'Professor criando questões de prova com base legal atualizada'
    ],
    tutorial: {
      passos: [
        'Acesse "Vade Mecum" no menu principal',
        'Digite palavras-chave na busca (ex: "responsabilidade civil")',
        'Use filtros por área: Civil, Penal, Trabalhista, etc.',
        'Clique no artigo para ver texto completo e atualizações',
        'Salve nos favoritos para acesso rápido'
      ],
      dicas: [
        'Use aspas para busca exata: "boa-fé objetiva"',
        'Combine filtros para resultados específicos',
        'Ative notificações de mudanças legislativas'
      ]
    },
    categoria: 'pesquisa',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante lê "Curso de Direito Civil" de Carlos Roberto Gonçalves',
      'Mestrando pesquisa artigos sobre "direito ao esquecimento" no STF',
      'Advogado consulta precedentes sobre união homoafetiva'
    ],
    casosUso: [
      'Graduando em Direito pesquisando para TCC sobre crimes cibernéticos',
      'Advogado civilista buscando jurisprudência atualizada sobre danos morais',
      'Professor atualizando material de aula com novas decisões do STJ'
    ],
    tutorial: {
      passos: [
        'Entre na "Biblioteca" pelo menu',
        'Escolha categoria: Livros, Jurisprudência ou Artigos',
        'Use filtros por tribunal, área ou período',
        'Baixe PDFs para leitura offline',
        'Crie sua biblioteca pessoal com favoritos'
      ],
      dicas: [
        'Baixe materiais importantes para estudar sem internet',
        'Use marcadores de página durante leitura',
        'Combine busca por autor e assunto'
      ]
    },
    categoria: 'estudo',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante assiste aula de Processo Penal com Prof. Aury Lopes Jr.',
      'Concurseiro estuda Direito Administrativo para Procuradoria do Estado',
      'OAB: revisão intensiva de Ética Profissional antes do exame'
    ],
    casosUso: [
      'Concurseiro estudando para Magistratura Estadual - foco em Processo Civil',
      'Estudante de graduação complementando aulas presenciais',
      'Advogado se especializando em Direito Digital'
    ],
    tutorial: {
      passos: [
        'Acesse "Videoaulas" no menu',
        'Escolha a disciplina (Civil, Penal, Constitucional, etc.)',
        'Selecione nível: Graduação, OAB ou Concursos',
        'Assista em sequência ou por tópicos específicos',
        'Faça anotações durante as aulas'
      ],
      dicas: [
        'Baixe vídeos para assistir offline',
        'Use velocidade 1.25x para otimizar tempo',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante escuta resumo do Código de Processo Civil no ônibus',
      'Concurseiro ouve podcast sobre mudanças na CLT durante caminhada',
      'Advogado escuta análise de julgados do STF no trânsito'
    ],
    casosUso: [
      'Estudante otimizando tempo durante deslocamento para faculdade',
      'Concurseiro revisando matéria durante exercícios físicos',
      'Profissional se atualizando durante viagens de trabalho'
    ],
    tutorial: {
      passos: [
        'Abra "Áudio-aulas" no menu',
        'Escolha disciplina ou podcast temático',
        'Baixe episódios para ouvir offline',
        'Use fones para melhor qualidade',
        'Marque trechos importantes'
      ],
      dicas: [
        'Crie playlists por matéria de concurso',
        'Ouça em velocidade normal para melhor compreensão',
        'Combine com leitura tradicional'
      ]
    },
    categoria: 'aprendizado',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante memoriza elementos dos crimes contra patrimônio',
      'Concurseiro fixa prazos processuais do CPC',
      'OAB: definições de princípios constitucionais'
    ],
    casosUso: [
      'Candidato à OAB memorizando conceitos para prova oral',
      'Concurseiro de Delegado fixando tipificação penal',
      'Professor criando material de revisão para turma'
    ],
    tutorial: {
      passos: [
        'Acesse "Flashcards" e escolha deck temático',
        'Estude seguindo algoritmo de repetição',
        'Avalie dificuldade: fácil, médio ou difícil',
        'Crie decks personalizados',
        'Acompanhe estatísticas de aprendizado'
      ],
      dicas: [
        'Estude 20-30 minutos diários',
        'Seja honesto na autoavaliação',
        'Revise cards difíceis mais vezes'
      ]
    },
    categoria: 'aprendizado',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante cria mapa da estrutura do Sistema Judiciário',
      'Concurseiro organiza tipos de responsabilidade civil',
      'Professor monta esquema do processo legislativo'
    ],
    casosUso: [
      'Graduando organizando matéria para prova de Constitucional',
      'Advogado montando estratégia para caso complexo',
      'Concurseiro conectando institutos para prova discursiva'
    ],
    tutorial: {
      passos: [
        'Entre em "Mapas Mentais"',
      ...
      dicas: [
        ...
        'Aplique cores consistentemente',
        'Revise mapas semanalmente'
      ]
    },
  ...
  },
  {
    ...
    exemplos: [
      'Estudante baixa "Manual de Direito Penal" para estudar offline',
      'Advogado obtém modelo de petição inicial trabalhista',
      'Contador baixa formulários atualizados da Receita Federal'
    ],
    casosUso: [
      'Advogado iniciante baixando modelos para montar escritório',
      'Estudante criando biblioteca pessoal para concursos',
      'Professor distribuindo material complementar'
    ],
    tutorial: {
      passos: [
        'Acesse "Downloads"',
        'Filtre por: Livros, Modelos ou Formulários',
        'Visualize prévia antes de baixar',
        'Baixe em formato editável',
        'Organize em pastas no dispositivo'
      ],
      dicas: [
        'Sempre adapte modelos ao caso específico',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante faz resumo de aula sobre Direito Empresarial',
      'Concurseiro anota jurisprudência importante do STF',
      'Advogado registra estratégias durante reunião com cliente'
    ],
    casosUso: [
      'Graduando organizando material para trabalho de conclusão',
      'Concurseiro criando fichamentos para revisão',
      'Advogado documentando andamento de processos'
    ],
    tutorial: {
      passos: [
        'Abra "Sistema de Anotações"',
        'Crie categorias por matéria',
        'Use formatação: negrito, listas, cores',
        'Adicione tags para busca rápida',
        'Sincronize entre dispositivos'
      ],
      dicas: [
        'Use títulos descritivos',
        'Revise anotações semanalmente',
  ...
  },
  {
    ...
    exemplos: [
      'Estudante pergunta sobre diferença entre dolo direto e eventual',
      'Advogado consulta sobre prazos para recurso especial',
      'Concurseiro tira dúvida sobre competência em processo penal'
    ],
    casosUso: [
      'Estudante com dúvida específica durante madrugada de estudos',
      'Advogado precisando de esclarecimento rápido antes de audiência',
      'Professor verificando conceitos para preparar aula'
    ],
    tutorial: {
      passos: [
        'Acesse "Assistente IA"',
        'Digite sua pergunta de forma clara',
        'Especifique área do direito se necessário',
        'Leia resposta e faça perguntas complementares',
        'Salve respostas úteis para consulta'
      ],
      dicas: [
        'Seja específico nas perguntas',
        'Confirme informações em fontes oficiais',
        'Use para esclarecer conceitos, não para substituir estudo'
      ]
    },
    categoria: 'pesquisa',
...
export const Explorar = () => {
  ...
  const categorias = [
    ...
    { id: 'pesquisa', nome: 'Pesquisa', icone: Search },
