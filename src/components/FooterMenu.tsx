...
export const FooterMenu = () => {
  ...
  // Find specific functions from the table
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 safe-area-pb">
      <div className="mx-2 mb-2 sm:mx-4 sm:mb-4">
        <div className="max-w-md mx-auto floating-effect rounded-2xl border border-border/20 shadow-2xl backdrop-blur-lg">
              ...
              return (
                ...
                >
                  ...
                  <div className={`relative p-1.5 sm:p-2 rounded-lg transition-all duration-300 ${
                    isActive 
                      ? 'bg-gradient-to-br from-primary/20 to-primary/30 shadow-sm transform scale-105' 
