...
import { Scale, Bot, Library, Headphones, Home, StickyNote, Search } from 'lucide-react';
            ...
            {menuItems.map(item => {
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center py-3 px-2 rounded-xl transition-all duration-300 transform active:scale-95 group min-w-0 flex-1 ${
                    isActive
                ...
                >
                  ...
                  <div className={`relative p-2 rounded-lg transition-all duration-300 ${
                    isActive ? 'bg-amber-500/20 scale-110' : 'group-hover:bg-amber-500/10 group-hover:scale-105'
                  }`}>
                  ...
                  <span className={`text-xs font-medium transition-all duration-300 mt-1 text-center leading-tight ${
                    isActive ? 'font-semibold text-amber-400' : 'group-hover:font-medium'
                  }`}>
                    {item.title}
                  </span>
