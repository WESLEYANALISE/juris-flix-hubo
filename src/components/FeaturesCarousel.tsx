  ...
  return (
    ...
    >
      ...
      <Button
        ...
        size="icon"
        onClick={prevSlide}
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-20 h-8 w-8 sm:h-10 sm:w-10 bg-background-deep/30 hover:bg-background-deep/50 text-white border border-white/20 hover:border-white/40 backdrop-blur-sm transition-all duration-300 hover:scale-110"
      >
      ...
      <Button
        ...
        size="icon"
        onClick={nextSlide}
        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-20 h-8 w-8 sm:h-10 sm:w-10 bg-background-deep/30 hover:bg-background-deep/50 text-white border border-white/20 hover:border-white/40 backdrop-blur-sm transition-all duration-300 hover:scale-110"
      >
        ...
        {carouselData.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${
              index === currentSlide
                ? 'bg-accent-legal shadow-lg shadow-accent-legal/50 scale-125'
